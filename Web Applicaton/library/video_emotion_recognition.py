...
def gen(scheduler_time):
    ...
    while end - start < max_time :
        ...
        for (i, rect) in enumerate(rects):
            ...
            cv2.rectangle(frame, (x, y), (x + w, y + h), (188, 28, 134), 2)
            
            # Top left : Put the ID of the face
            cv2.putText(frame, "Face #{}".format(i + 1), (x - 10, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 0), 1)
